...
const (
	//standesamtLibDirBase = ".standesamt"
			...
			"schema_reference": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"path": schema.StringAttribute{
						Optional:            true,
						Description:         "The path in the default schema library, e.g. `azure/default`. Also requires `ref`. Conflicts with `custom_url`.",
						MarkdownDescription: "The path in the default schema library, e.g. `azure/default`. Also requires `ref`. Conflicts with `custom_url`.",
						Validators: []validator.String{
					...
					"ref": schema.StringAttribute{
						Optional:            true,
						Description:         "This is the version of the schema reference to use, e.g. `2025.03.1`. Also requires `path`. Conflicts with `custom_url`.",
						MarkdownDescription: "This is the version of the schema reference to use, e.g. `2025.03.1`. Also requires `path`. Conflicts with `custom_url`.",
						Validators: []validator.String{
							stringvalidator.ConflictsWith(path.MatchRelative().AtParent().AtName("custom_url")),
				...
				Optional:            true,
				Description:         "A reference to a Naming schema library to use. The reference should either contain a `path` (e.g. `azure/default`) and the `ref` (e.g. `2025.03.1`), or a `custom_url` to be supplied to go-getter.\nIf this value is not specified, the default value will be used, which is:\n\n```terraform\nschema_reference= {\n path = \"azure/default\", ref = \"2025.03.1\"\n}\n```\n\n",
				MarkdownDescription: "A reference to a Naming schema library to use. The reference should either contain a `path` (e.g. `azure/default`) and the `ref` (e.g. `2025.03.1`), or a `custom_url` to be supplied to go-getter.\nIf this value is not specified, the default value will be used, which is:\n\n```terraform\nschema_reference= {\n path = \"azure/default\", ref = \"2025.03.1\"\n}\n```\n\n",
			},
		},
	}
}
